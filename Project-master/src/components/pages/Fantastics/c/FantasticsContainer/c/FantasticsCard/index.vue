<template>
  <div class="column">
    <span class="film-card">
      ...
      <span class="year-of-release">Год выпуска: {{filmData.yearOfRelease}}</span>
    </span>
  </div>
</template>
...
props: {
  ...
  computed: {
    filmSrc() {
      return require(`@/assets/FantasticsPhotos/${this.filmData.img}`);
    }
  }
};
</script>
...
.film-card {
  background-color: rgba(246, 242, 242, 0.904);
  width: 250px;
  height: 380px;
  display: flex;
